...
os.makedirs("python-gerador-pdf", exist_ok=True) # Cria a pasta para o PDF, mas se a pasta já existir, não cria nada.
...
cnv = canvas.Canvas("python-gerador-pdf/avaliacao-do-funcionario.pdf") # Cria o PDF.
cnv.drawImage("python-gerador-pdf/plano-de-fundo.png", 0, 0, width=A4[0], height=A4[1]) # Insere o plano de fundo do PDF.
